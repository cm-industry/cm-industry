...
export default function AboutPageClient() {
  return (
    <>
          ...
          <section className="mt-16">
            ...
            <div className="flex flex-col items-center gap-4 mb-10">
              ...
              <MotionLink
                ...
                transition={{ type: 'spring', stiffness: 700, damping: 15 }}
                style={{ backfaceVisibility: 'hidden', willChange: 'transform' }}
                className="w-full max-w-xs text-2xl md:text-2xl font-bold uppercase py-3 px-6 border border-transparent transition-colors -mb-12"
              >
                Posters
              </MotionLink>
            </div>
      ...
      <section className="w-full bg-[#101010] py-16 pb-8">
        <Footer />
      </section>
    </>
  );
