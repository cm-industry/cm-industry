...
export default function GalleryContent() {
  ...
  return (
    <div className="bg-[#101010] min-h-screen text-white pt-[140px] md:pt-[180px]">
      <nav className="fixed top-[30px] md:top-[104.8px] w-full bg-[#101010] z-10 flex flex-wrap justify-center gap-4 md:gap-16 text-base md:text-xl mt-4 md:mt-0 py-4 md:py-8 shadow-md">
